...
<div id="app">
    <!-- Navigation-->
    <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" style="box-shadow: 0 0.5rem 1rem rgba(0, 0, 0, 0.15); background-color: #fff;">
        <div class="container px-4 px-lg-5">
            <a class="navbar-brand" href="{{ url('/') }}">Развлекательный центр "ДЖУНГЛИ"</a>
